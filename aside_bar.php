...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="#" class="brand-link">
    ...
    <span class="brand-text font-weight-light">Dev Helal</span>
  </a>
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      <div class="image">
        <img src="<?php echo $_SESSION['base_url'] ?>/dist/img/helal.jpg" class="img-circle elevation-2"
          alt="User Image">
      </div>
      <div class="info">
