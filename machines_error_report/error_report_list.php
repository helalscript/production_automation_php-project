...
$machines_error = $con->query("SELECT * from error_reports")->fetch_all(MYSQLI_ASSOC);
                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-md-2 offset-8 text-right">
                                <a href="<?php echo $_SESSION['base_url'] ?>/machines_error_report/error_report_add.php"
                                    class="btn btn-warning">Add Machines Error</a>
                            </div>
                        </div>
                    </div>
                    <!-- /.card-header -->
