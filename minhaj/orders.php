...
if (isset($_POST['submit'])) {
    ...
    $con->query("insert into orders(invoice,project_id,buyer_id,start_date,end_date,quantity,unit_id,project_manager_id,supervisor_id,rate,status,total_price) VALUES ('$invoice','$project','$buyer','$start_date','$end_date','$quantity','$unit','$manager',' $supervisor','$rate','$status','$total_price')");
    ?>
    <script>
