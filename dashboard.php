            ...
            <div class="card-body">
              <div class="row">
                <div class="col-md-8">
                  <p class="text-center">
                    <strong>Order:
                      <span class="col-4"> <?php echo $dt2 = (new DateTime('-1 month'))->format('d-M-Y');?></span>
                       <span style="color:green" class="col-2">To</span>
                       <span class="col-4"><?php echo $dt1 = (new DateTime())->format('d-M-Y'); ?></span>
                    </strong>
                  </p>
                ...
                <table class="table m-0">
                  ...
                  <tbody>
                    ...
                    foreach($t_orders as $tii=>$til ){
                     ?>
                    <tr>
                      <td><?php echo $til['invoice'] ?></td>
                      <td><?php echo $til['quantity'] ?></td>
                      <td><span > <?php 
                      if($til['status']=='running'){
                       ?>
                        <span class="badge badge-success" ><?php echo $til['status']; ?></span>  <?php
                      }else{?>
                        <span class="badge badge-danger" ><?php echo $til['status']; ?></span>  <?php
                      }
                       ?></span></td>
                      <td ><?php echo $til['total_price'] ?> </td>
                    </tr>
                    <?php }?>
                    <!-- <tr>
              ...
              <ul class="products-list product-list-in-card pl-2 pr-2">
                ...
                <li class="item">
                  ...
                  <div class="product-info">
                    <a href="#" class="product-title"><?php echo $llp['invoice_id']?>
                      <span class="badge badge-warning float-right">$<?php echo $llp['price']?></span></a>
