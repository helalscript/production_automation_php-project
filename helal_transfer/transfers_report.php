                        ...
                        <table class="table table-bordered">
                            ...
                            <?php foreach ($trasfer as $ti => $tl) { ?>
                                    <tr>
                                        ...
                                        if($target < $total){?>
                                           <h5>👎 <span style="background-color:#ff5050">  <?php echo "  Doing over time ";?></span> </h5>
                                           
                                           <?php
                                           
                                        }
                                        if($total == '' ){ ?>
                                            ✎ <span style="background-color:#ffc107"><?php echo " Runnig ";?></span> 
                                           
                                            <?php

                                            } 
                                        if($total != '' && $target > $total){?>👍 
                                            <span style="background-color:#45d045"><?php echo " Doing Right time ";?></span><?php
                                            } }else{
